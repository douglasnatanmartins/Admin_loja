...
class ProductBloc extends BlocBase {
  ...
  void saveStock(String stock) {
    unsavedData["stock"] = stock;
  }

  void saveUnidadeMedida(String UnidadeMedida) {
    unsavedData["unidadMedida"] = UnidadeMedida;
  }

  void savePriceAnterior(String PriceAnterior){
    unsavedData["priceAnterior"] = PriceAnterior;
  }
  ...
  //salvando imagens no storage do firebase
